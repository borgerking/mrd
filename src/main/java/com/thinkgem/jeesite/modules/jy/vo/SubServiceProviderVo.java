...
public class SubServiceProviderVo {
	private Date transactionDate;		// 交易日期	
	private String settlementModel;		// 结算模式
	private String merchantName;		// 子服务商名称
	private String transactionNumber;		// 交易笔数
	private String transactionAmount;		// 交易金额
	private String serviceCharge;		// 交易手续费
	
	public SubServiceProviderVo() {
		
	}
	
	public SubServiceProviderVo(Date transactionDate, String settlementModel, String merchantName
			, String transactionNumber, String transactionAmount, String serviceCharge) {
	...
	@ExcelField(title="子服务商名称", type=1, align=2, sort=30 )
	...
	@ExcelField(title="消费笔数", type=1, align=2, sort=40 )
	...
	@ExcelField(title="消费金额", type=1, align=2, sort=50 )
	...
	@ExcelField(title="交易手续费", type=1, align=2, sort=60 )
