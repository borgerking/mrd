	...
	public ImageGeo(String filename) {
		try {
			...
			Rational latpart[] = gpsdir
					.getRationalArray(GpsDirectory.TAG_LATITUDE);
			Rational lonpart[] = gpsdir
					.getRationalArray(GpsDirectory.TAG_LONGITUDE);
			String northing = gpsdir
					.getString(GpsDirectory.TAG_LATITUDE_REF);
			String easting = gpsdir
					.getString(GpsDirectory.TAG_LONGITUDE_REF);
